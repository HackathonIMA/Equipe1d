 ...
 */
public class InProgressMonitoringAdapter extends RecyclerView.Adapter<InProgressMonitoringAdapter.ViewHolder> {

    private final List<Monitoring> monitoringList;
    private final InProgressMonitoringFragment.OnInProgressInteractionListener listener;

    public InProgressMonitoringAdapter(List<Monitoring> monitoringList, InProgressMonitoringFragment.OnInProgressInteractionListener listener) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != listener) {
                    ...
                    listener.onInProgressInteraction();
                }
            }
        });
    }
