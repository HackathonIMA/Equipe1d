 ...
 * specified {@link ArchivedMonitoringFragment.OnArchivedInteractionListener}.
 */
public class ArchivedMonitoringAdapter extends RecyclerView.Adapter<ArchivedMonitoringAdapter.ViewHolder> {

    private final List<Monitoring> monitoringList;
    private final ArchivedMonitoringFragment.OnArchivedInteractionListener listener;

    public ArchivedMonitoringAdapter(List<Monitoring> monitoringList, ArchivedMonitoringFragment.OnArchivedInteractionListener listener) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != listener) {
                    ...
                    listener.onArchivedInteraction(holder.mItem);
                }
            }
        });
    }
